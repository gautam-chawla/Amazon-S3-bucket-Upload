...
// Amazon S3 configuration by Gautam Chawla
// https://github.com/gautam-chawla
/*
|--------------------------------------------------------------------------
| Use SSL
|--------------------------------------------------------------------------
...
$config['access_key'] = 'YOUR_AMAZON_ACCESS_KEY';
...
$config['secret_key'] = 'YOUR_AMAZON_ACCESS_SECRET';
...
$config['folder_name'] = 'BUCKET_FOLDER';
...
$config['s3_url'] = 'S3_URL'; //https://amazonaws.com/
...
|--------------------------------------------------------------------------
|
| Your Amazon Version Name.
|
*/
$config['version'] = 'API_VERSION'; // use 'latest'
...
|--------------------------------------------------------------------------
|
| Your Amazon S3 Bucket Region Name.
|
*/
$config['region'] = 'REGION'; // like us-east-2
...
|
*/
$config['access_key_envname'] = 'YOUR_AMAZON_ACCESS_KEY';
...
|
*/
$config['secret_key_envname'] = 'YOUR_AMAZON_ACCESS_SECRET';
